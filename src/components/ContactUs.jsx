...
const ContactUs = () => {
  ...
  return (
    ...
    id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Title title='Reach out to me' desc='Open to frontend opportunities and collaborations.'/>
      ...
      <motion.form 
        ...
        <button type="submit" className='w-max sm:col-span-2 justify-self-center flex gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 text-center transition-all'>
