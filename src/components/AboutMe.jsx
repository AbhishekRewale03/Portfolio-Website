...
const AboutMe = ({theme}) => {
    return (
        <div id='about_me' className='flex flex-col items-center center w-full pb-30 text-gray-700 dark:text-white
                        px-4 sm:px-12 lg:px-24 xl:px-40 pt-30'>
            <Title title='About me' />
            <div className='flex flex-col justify-evenly gap-15 mt-8 lg:flex-row'>
                <div className=' relative py-4  flex justify-center'>
                    <img src={theme === "dark" ? assets.avatar : assets.avatar_bg_white} className=' max-h-100  max-w-xs
                ...
                <div className=' py-6 '>
                    ...
                    <div className='flex justify-center lg:justify-start gap-7 mt-10'>
                        <a href="#contact-us" className='text-sm  flex items-center gap-2 bg-primary text-white py-3 px-5 rounded-full cursor-pointer hover:scale-103 transition-all'>
                            Connect <img src={assets.arrow_icon} width={14} alt="" />
                        </a>
                        <a href="/Abhishek Rewale resume.pdf" download className='text-sm  flex items-center gap-2  text-black dark:text-white  border border-black dark:border-gray-400 py-3 px-4 rounded-full cursor-pointer hover:scale-103 transition-all'>
